...
namespace Jeux01.Monstre
{
    class MonstreBoss1 : BaseMonstre
    {
        ...
        public MonstreBoss1 Monstre1Boss1 { get; set; }
        public int PointDeVieMonstreBoss1 { get; set; } = 30000;
        public int PointAttaqueMonstreBoss1 { get; set; } = 25;
        /*public Sandra Sandra { get; set; }
        public Leatitia Leatitia { get; set; }
        public Morgane Morgane { get; set; }
        public Astrid Astrid { get; set; }
        public Fanny Fanny { get; set; }
        public Manon Manon { get; set; }
        public Christelle Christelle { get; set; }
        */
        ...
        public MonstreBoss1(string nom) : base(nom)
        {
        }
