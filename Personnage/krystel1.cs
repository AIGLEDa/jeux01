...
namespace Jeux01.Personnage
{
    class krystel : BasePersonnage
    {
        ...
        public static int PointDeViekrystel { get; set; } = 6000;
            ...
            while (Monstre1.PointDeVieMonstre1 > 0)
            {
                ...
                if (TourAleatoireAttaqueValeur == 3)
                {
                    ...
                    if (typeMenu == (int)EnumMenuPerso2.AttaqueCibler)
                    {
                        ...
                        {
                            Console.WriteLine("krystel ne peut pas encore effectuer un coup critique");
                        }
                    ...
                    if (typeMenu == (int)EnumMenuPerso2.BoirePotionVie && krystel.BoirePotion < 6)
                    {
                        ...
                        krystel.PointDeViekrystel = krystel.PointDeViekrystel + 800;
                        Console.WriteLine($"Julie à maitenant en point de vie {krystel.PointDeViekrystel}");
                    }
