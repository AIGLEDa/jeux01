            ...
            public void AttaquerJulie(Monstre1 Monstre1, Personnage1 Personnage1)
            {
                while (Monstre1.PointDeVieMonstre1 > 0)
                {
                    ...
                    if (TourAleatoireAttaqueValeur == 3)
                    {
                        ...
                        Console.WriteLine("Morgane attaque");
                        ...
                        Morgane.PointDeViePersonnage2 = Morgane.PointDeViePersonnage2 + 800;
                            Console.WriteLine($"Julie à maitenant en point de vie {Morgane.PointDeViePersonnage2}");
                        }
